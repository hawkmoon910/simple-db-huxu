...
**Part 1 due: Monday, April 7th 11:59PM**

**Due: Wednesday, April 16th 11:59 PM**
...
2.  Visit the [GitLab SSH key management page](https://gitlab.cs.washington.edu/-/user_settings/ssh_keys). You'll need to log in using your CSE account.
...
```sh
$ git clone git@gitlab.cs.washington.edu:cse444-25sp/simple-db-MY_GITLAB_USERNAME.git
...
$ git remote add upstream git@gitlab.cs.washington.edu:cse444-25sp/simple-db.git
```
...
```sh
$ git remote -v
  origin  git@gitlab.cs.washington.edu:cse444-25sp/simple-db-username.git (fetch)
  origin  git@gitlab.cs.washington.edu:cse444-25sp/simple-db-username.git (push)
  upstream    git@gitlab.cs.washington.edu:cse444-25sp/simple-db.git (fetch)
  upstream    git@gitlab.cs.washington.edu:cse444-25sp/simple-db.git (push)
```
...
To git@gitlab.cs.washington.edu:cse444-25sp/simple-db-username.git
...
From gitlab.cs.washington.edu:cse444-25sp/simple-db
...
#### NOTE: Which Java JDK version to use:
It's advised that you install the Java 11 JDK for use with SimpleDB, generally you encounter fewer problems and compiler warnings this way. See the [Oracle downloads page](https://www.oracle.com/th/java/technologies/downloads/#java11) to download Java 11 jdk, and set that to be your Java version for the SimpleDB project when importing into your IDE.
...
After executing the `turnInLab.sh` script, make sure to check your repository on GitLab to ensure that the tag has been property applied!  You may do this by visiting `https://gitlab.cs.washington.edu/cse444-25sp/simple-db-YOUR_USERNAME/tags`.
...
To git@gitlab.com:cse444-25sp/hw-answers-pirateninja.git
 - [deleted]         lab1
...
```sh
$ git clone git@gitlab.cs.washington.edu:cse444-25sp/simple-db-username.git confirmation_directory
