...
## DEADLINES
##### Part 1 Due: Friday April 25th, 2025
##### Due: Wednesday, April 30th, 2025
...
As in the case of Lab 1, we will only visually inspect your implementation at this point. We will NOT run any unit tests. However, you are strongly advised to ensure that your code passes the tests. Of course, when you submit your solution for the entire lab, we will run all unit tests.
...
To git@gitlab.com:cse444-25sp/simple-db-pirateninja.git
 - [deleted]         lab2
...
To git@gitlab.com:cse444-25sp/hsimple-db-pirateninja.git
 * [new tag]         lab2 -> lab2
```
